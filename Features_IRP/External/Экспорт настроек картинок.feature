...
Сценарий: экспорт настроек картинок
	...
	И я перезаполняю для объекта табличную часть "ConnectionSetting":
		| 'Ref'                                                                         | 'Key'         | 'Value'                               |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49494' | 'AddressPath' | 'C:\\Users\\79268\\Documents\\GitHub\\TestQA\\Files\\itempicture1.png'  |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49495' | 'AddressPath' | 'C:\\Users\\79268\\Documents\\GitHub\\TestQA\\Files\\itempicture2.png' |
